...
public class ProductInventoryTests
{
    ...
    public void Test_DisplayInventory_WithProducts_ReturnsFormattedInventory()
    {
        ...
        double productPrice = 10;
        int productQuantity = 5;
        string productName2 = "fig";
        double productPrice2 = 20;
        int productQuantity2 = 6;

        string expected = $"Product Inventory:{Environment.NewLine}" +
            $"bannana - Price: $10.00 - Quantity: 5{Environment.NewLine}" +
            $"fig - Price: $20.00 - Quantity: 6";
